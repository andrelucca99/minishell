...
SRCS = src/main.c src/garbage_free.c src/sigint.c \
	...
	src/executor/executor.c src/executor/executor_child.c src/executor/utils.c src/executor/utils_exec_child.c src/executor/utils_exec_fork.c src/tokens.c \
